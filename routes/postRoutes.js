...
router.post('/', function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            ...
            case 2:
                e_1 = _a.sent();
                res.status(500).json({ error: "The post could not be created: " + e_1.message });
                return [3 /*break*/, 3];
...
router.get('/', function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                _a.trys.push([0, 2, , 3]);
                return [4 /*yield*/, postController_1.getPosts()];
            case 1:
                posts = _a.sent();
...
router.post('/filter', function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                _a.trys.push([0, 2, , 3]);
                return [4 /*yield*/, postController_1.filterPosts(req.body)];
            case 1:
                posts = _a.sent();
                res.status(200).json(posts);
                return [3 /*break*/, 3];
...
router.delete('/:id', function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                _a.trys.push([0, 2, , 3]);
                return [4 /*yield*/, postController_1.deletePost(req.params.id)];
            case 1:
                post = _a.sent();
            ...
            case 2:
                e_4 = _a.sent();
                res.status(500).json({ error: "The post could not be deleted: " + e_4.message });
                return [3 /*break*/, 3];
            case 3: return [2 /*return*/];
        }
    });
