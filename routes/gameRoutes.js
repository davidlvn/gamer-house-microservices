...
router.post('/', function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                _a.trys.push([0, 2, , 3]);
                return [4 /*yield*/, gameController_1.createGame(req.body)];
            case 1:
                game = _a.sent();
            ...
            case 2:
                e_1 = _a.sent();
                res.status(500).json({ error: "The game could not be created: " + e_1.message });
                return [3 /*break*/, 3];
...
router.put('/', authenticationMiddleware_1.default, function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            ...
            case 2:
                e_2 = _a.sent();
                res.status(500).json({ error: "The game could not be added to the user list: " + e_2.message });
                return [3 /*break*/, 3];
            case 3: return [2 /*return*/];
        }
    });
...
router.delete('/:id', authenticationMiddleware_1.default, function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            ...
            case 2:
                e_3 = _a.sent();
                res.status(500).json({ error: "The game could not be added to the user list: " + e_3.message });
                return [3 /*break*/, 3];
            case 3: return [2 /*return*/];
        }
    });
...
router.get('/', function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                _a.trys.push([0, 2, , 3]);
                return [4 /*yield*/, gameController_1.getGames()];
            case 1:
                games = _a.sent();
            ...
            case 2:
                e_4 = _a.sent();
                res.status(500).json({ error: "The games could not be found: " + e_4.message });
                return [3 /*break*/, 3];
            case 3: return [2 /*return*/];
        }
    });
