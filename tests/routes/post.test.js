    ...
    mongoose_1.default.connect(DEV_DB_CONNECTION_STRING, { useNewUrlParser: true, useUnifiedTopology: true }, function () { return __awaiter(void 0, void 0, void 0, function () {
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 1:
                    gamer = _a.sent();
                    return [4 /*yield*/, postTagController_1.createPostTag({
                            name: 'Test',
...
describe('Routes posts/', function () {
    it('should respond with an error 500 with a no authenticated user', function () { return __awaiter(void 0, void 0, void 0, function () {
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, supertest_1.default(app).get('/posts/').expect(500)];
                case 1:
                    _a.sent();
                    return [4 /*yield*/, supertest_1.default(app).post('/posts/').expect(500)];
                case 2:
                    _a.sent();
                    return [4 /*yield*/, supertest_1.default(app).post('/posts/filter/').expect(500)];
                case 3:
                    _a.sent();
                    return [2 /*return*/];
            }
...
describe('POST/ posts/', function () {
    it('should respond with an error for an nonexistent user', function () { return __awaiter(void 0, void 0, void 0, function () {
        var data;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
    ...
    it('should respond with an error for an nonexistent tag', function () { return __awaiter(void 0, void 0, void 0, function () {
        var data;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
    ...
    it('should respond with an error for an nonexistent content', function () { return __awaiter(void 0, void 0, void 0, function () {
        var data;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    ...
                    return [4 /*yield*/, supertest_1.default(app)
                            ...
                            .expect(500)
                            .expect({
                            error: 'The post could not be created: Post validation failed: content: Path `content` is required.',
                        })];
                case 1:
                    _a.sent();
                    return [2 /*return*/];
    ...
    it('should respond with an error for an nonexistent name', function () { return __awaiter(void 0, void 0, void 0, function () {
        var data;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    ...
                    return [4 /*yield*/, supertest_1.default(app)
                            ...
                            .expect(500)
                            .expect({
                            error: 'The post could not be created: Post validation failed: name: Path `name` is required.',
                        })];
                case 1:
                    _a.sent();
                    return [2 /*return*/];
    ...
    it('should create the post and add it to the writer posts list', function () { return __awaiter(void 0, void 0, void 0, function () {
        var data;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
...
describe('DELETE/ posts/', function () {
    it('should respond with an error for a nonexistent post', function () { return __awaiter(void 0, void 0, void 0, function () {
        return __generator(this, function (_a) {
            switch (_a.label) {
    ...
    it('should delete the post and remove it from writer posts list', function () { return __awaiter(void 0, void 0, void 0, function () {
        var data, post;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    ...
                    return [4 /*yield*/, postController_1.createPost(data)];
                case 1:
                    post = _a.sent();
                    return [4 /*yield*/, supertest_1.default(app)
